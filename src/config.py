...
# .env ფაილიდან გარემოს ცვლადების ჩატვირთვა (API გასაღები და backend აქ ინახება,
# რომ ყოველ გაშვებაზე ხელით არ ჩაიწეროს). თუ python-dotenv არ არის — ჩუმად გამოვტოვებთ.
try:
